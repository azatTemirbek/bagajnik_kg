...
@Component({
  selector: 'app-jumbo-child-one',
  templateUrl: './jumboChildOne.component.html',
  styleUrls: ['./jumboChildOne.component.css']
})
export class JumboChildOneComponent implements OnInit, AfterViewInit {
  ffa: any;
  tfa: any;
